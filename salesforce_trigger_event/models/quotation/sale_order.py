...
class SaleOrder(models.Model):
    ...
    def create_lines_to_sf_by_cron(self):
        ...
        self._event('on_sale_order_create_bulk').notify(lines_to_process, fields)
...
class SaleOrderListener(Component):
    ...
    def on_sale_order_create_bulk(self, records, fields):
        rest_request = self.env['salesforce.rest.config'].build_request(records, fields, 'create', 'sale_order_create_bulk')
